...
Source0  : https://cpan.metacpan.org/authors/id/R/RH/RHANDOM/Net-Server-2.013.tar.gz
...
%prep
%setup -q -n Net-Server-2.013
cd %{_builddir}
tar xf %{_sourcedir}/libnet-server-perl_2.009-1.debian.tar.xz
cd %{_builddir}/Net-Server-2.013
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Net-Server-2.013/deblicense/
